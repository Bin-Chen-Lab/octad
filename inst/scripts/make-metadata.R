...
RDataPath=c('octad.db/data/CCLE.log2.read.count.matrix.rda',
  'octad.db/data/CCLE.overlaps.rda',
  'octad.db/data/CCLE.sample.meta.rda',
  'octad.db/data/CTRPv2.sensprof.rda',
  'octad.db/data/EncoderDF.rda',
  'octad.db/data/cmpd_sets_ChemCluster.rda',
  'octad.db/data/cmpd_sets_chembl_targets.rda',
  'octad.db/data/cmpd_sets_mesh.rda',
  'octad.db/data/fda_drugs.rda',
  'octad.db/data/lincs_sig_info.rda',
  'octad.db/data/lincs_signatures.rda',
  'octad.db/data/merged_gene_info.rda',
  'octad.db/data/octad.LINCS.counts.rda',
  'octad.db/data/phenoDF.rda',
  'octad.db/data/random_gsea_score.rda',
  'octad.db/data/tsne.rda',
  'octad.db/data/octad.counts.and.tpm.h5'
),
