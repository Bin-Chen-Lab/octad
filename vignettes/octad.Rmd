...
sRGES=runsRGES(res,max_gene_size=100,permutations=10000,outputFolder=tempdir())
...
```{r eval=TRUE} 
topLineEval(topline = c('HEPG2'),mysRGES = sRGES,outputFolder=paste0(tempdir(),'/'))
```
...
```{r eval=TRUE} 
octadDrugEnrichment(sRGES = sRGES, target_type = c('chembl_targets','mesh','ChemCluster'),enrichFolder=paste0(tempdir(),'/'))
```
