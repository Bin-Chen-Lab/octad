...
```{r eval=TRUE} 
#select data
HCC_primary=subset(octad.db::phenoDF,cancer=='liver hepatocellular carcinoma'&sample.type == 'primary') #select data
...
BIC_with_PIK3_primary=subset(octad.db::phenoDF,cancer=='breast invasive carcinoma'&sample.type == 'primary'&grepl('PIK3CA',mutation_list))
```
...
control_id =subset(octad.db::phenoDF,cancer=='liver lepatocellular carcinoma'&
...
```{r eval=TRUE} 
HCC_adjacent=subset(octad.db::phenoDF,cancer=='liver hepatocellular carcinoma'&sample.type == 'adjacent'&data.source == 'TCGA') 
...
HCC_primary=subset(octad.db::phenoDF,cancer=='liver hepatocellular carcinoma'&sample.type == 'primary') #select data
case_id=HCC_primary$sample.id #select cases
control_id=subset(octad.db::phenoDF,cancer=='liver hepatocellular carcinoma'&
           sample.type == 'adjacent' & data.source == 'TCGA') 
