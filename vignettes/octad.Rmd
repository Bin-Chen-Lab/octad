...
```{r eval=FALSE} 
data("res_example",package='octad.db') #load differential expression example for HCC vs adjacent liver tissue computed in diffExp() function from previous step
...
octadDrugEnrichment(sRGES = sRGES_example, target_type='chembl_targets',enrichFolder=paste0(tempdir(),'/'))
```
