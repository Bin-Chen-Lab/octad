...
#dz = "" #liver hepatocellular carcinoma" colon adenocarcinoma
dzs = rev(dzs)
for (dz in dzs){
...
ref_tissue_cor_cutoff = 0.2 #threshold used to choose the most correlated normal tissue samples.
...
print(paste("running target predictions"))a
